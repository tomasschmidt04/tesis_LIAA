...
- Pasos/corridas_finales_half_data/pretraining_beto_scanpath_lambda_limpio_half/split_report.json
- Pasos/corridas_finales_half_data/pretraining_beto_scanpath_lambda_limpio_half/README_paso_7.txt
- Pasos/corridas_finales_half_data/pretraining_beto_scanpath_lambda_limpio_half/salida_training_step7.txt
- Pasos/corridas_finales_half_data/pretraining_beto_scanpath_lambda_limpio_half/comandos_y_funciones.txt
- Pasos/corridas_finales_half_data/pretraining_beto_scanpath_lambda_limpio_half/lambda_scanpath_log.csv si adaptive_scanpath_weight=True
- Pasos/corridas_finales_half_data/pretraining_beto_scanpath_lambda_limpio_half/checkpoint_epoch_*/ si save_every_epoch=True
- Pasos/corridas_finales_half_data/pretraining_beto_scanpath_lambda_limpio_half/best_checkpoint/
- Pasos/corridas_finales_half_data/pretraining_beto_scanpath_lambda_limpio_half/checkpoint_final/
...
- model_name_or_path usado: dccuchile/bert-base-spanish-wwm-cased
- tokenizer detectado: BertTokenizerFast
- vocab_size detectado: 31002
- model_type detectado: bert
- hidden_size detectado: 768
- num_hidden_layers detectado: 12
...
- split_report_path = Pasos/corridas_finales_half_data/pretraining_beto_scanpath_lambda_limpio_half/split_report.json
- max_train_samples = 19259
- max_eval_samples = 4815
- num_train_epochs = 8
...
- scanpath_weight_log_path = Pasos/corridas_finales_half_data/pretraining_beto_scanpath_lambda_limpio_half/lambda_scanpath_log.csv
