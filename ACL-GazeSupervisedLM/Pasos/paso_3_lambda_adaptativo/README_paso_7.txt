...
- Pasos/paso_3_lambda_adaptativo/split_report.json
- Pasos/paso_3_lambda_adaptativo/README_paso_7.txt
- Pasos/paso_3_lambda_adaptativo/salida_training_step7.txt
- Pasos/paso_3_lambda_adaptativo/comandos_y_funciones.txt
- Pasos/paso_3_lambda_adaptativo/lambda_scanpath_log.csv si adaptive_scanpath_weight=True
- Pasos/paso_3_lambda_adaptativo/checkpoint_epoch_*/ si save_every_epoch=True
- Pasos/paso_3_lambda_adaptativo/best_checkpoint/
- Pasos/paso_3_lambda_adaptativo/checkpoint_final/
...
- split_report_path = Pasos/paso_3_lambda_adaptativo/split_report.json
- max_train_samples = 8
- max_eval_samples = 5
- num_train_epochs = 3
...
- scanpath_weight_update_metric = train_loss_scanpath_mean
- scanpath_weight_log_path = Pasos/paso_3_lambda_adaptativo/lambda_scanpath_log.csv
