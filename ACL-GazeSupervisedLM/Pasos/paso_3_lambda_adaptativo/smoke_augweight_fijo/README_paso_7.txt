...
- Pasos/paso_3_lambda_adaptativo/smoke_augweight_fijo/split_report.json
- Pasos/paso_3_lambda_adaptativo/smoke_augweight_fijo/README_paso_7.txt
- Pasos/paso_3_lambda_adaptativo/smoke_augweight_fijo/salida_training_step7.txt
- Pasos/paso_3_lambda_adaptativo/smoke_augweight_fijo/comandos_y_funciones.txt
- Pasos/paso_3_lambda_adaptativo/smoke_augweight_fijo/lambda_scanpath_log.csv si adaptive_scanpath_weight=True
- Pasos/paso_3_lambda_adaptativo/smoke_augweight_fijo/checkpoint_epoch_*/ si save_every_epoch=True
- Pasos/paso_3_lambda_adaptativo/smoke_augweight_fijo/best_checkpoint/
- Pasos/paso_3_lambda_adaptativo/smoke_augweight_fijo/checkpoint_final/
...
- split_strategy = sentence_position
- eval_sentence_position_mod = 10
- eval_sentence_position_remainder = 5
- split_report_path = Pasos/paso_3_lambda_adaptativo/smoke_augweight_fijo/split_report.json
- max_train_samples = 4
- max_eval_samples = 2
- num_train_epochs = 1
