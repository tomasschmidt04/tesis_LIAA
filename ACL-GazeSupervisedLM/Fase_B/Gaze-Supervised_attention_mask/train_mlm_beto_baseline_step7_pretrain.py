...
from train_mlm_scanpath_step5 import build_static_masked_inputs_and_labels, set_seed
...
def collate_baseline_mlm_batch(examples: List[Dict[str, Any]], tokenizer):
...
def train_step7_baseline(args):
    ...
    train_loader = DataLoader(
        ...
        shuffle=False,
        collate_fn=lambda batch: collate_baseline_mlm_batch(batch, tokenizer),
    )
    eval_loader = None
    if eval_examples:
